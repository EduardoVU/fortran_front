...
// Tipos de respuesta generales para las peticiones
...
// Tipos de parámetros para las funciones
interface Headers {
...
export default {
  // Login
  login(data: LoginData, headers: Headers): Promise<AxiosResponse<ApiResponse>> {
  ...
  // Get user info
  getInfoUser(data: any, headers: Headers): Promise<AxiosResponse<ApiResponse>> {
